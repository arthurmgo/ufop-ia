...
public class EstadoJogo {
    ...
    boolean isTerminal() throws CloneNotSupportedException {

        return loboLose() || loboWin();

    }

    public double getValue() throws CloneNotSupportedException {
        if(loboWin()){
            return 1;
        }else if(loboLose()){
            return -1;
    ...
    public boolean loboWin() throws CloneNotSupportedException {
        int posicaoLobo[] = new int[2];
        posicaoLobo = tab.buscaPosicao(-1);
        if (posicaoLobo[0] == 7) {
            return true;
        }
        if (estadosAlcancaveis(1).size() == 0 && estadosAlcancaveis(1).size() != 0) {
            return true;
        }
        return false;
    ...
    public boolean loboLose() throws CloneNotSupportedException {
        if (!(loboWin()) && estadosAlcancaveis(0).size() == 0) {
            return true;
